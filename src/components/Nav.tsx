                        ...
                        >
                            ...
                            {userData && (
                                <div className="flex items-center gap-3 pb-3 border-b border-white/10">
                                    <div className="w-10 h-10 rounded-full bg-white text-black font-extrabold flex items-center justify-center text-sm uppercase overflow-hidden">
                                        {userData.image ? (
                                            <Image
                                                src={userData.image}
                                                alt={userData.name || "User"}
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[11px] font-medium tracking-wider text-gray-400 uppercase mt-0.5">
                                            {userData.role || "USER"}
                                        </p>
                                    </div>
                                </div>
